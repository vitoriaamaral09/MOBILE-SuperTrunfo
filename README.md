...
- Estilos definidos com `StyleSheet.create()`.
...
2️⃣ No diretório do projeto:
```bash
npm install
npm start
```

3️⃣ Escaneie o QR Code com o **Expo Go** (Android/iOS) para visualizar.
...
## 📘 Créditos
Baseado no exemplo do professor **Thyerri Mezzari**  
Repositório original: [super-trunfo-f1](https://github.com/thyerrimezzari/super-trunfo-f1)
